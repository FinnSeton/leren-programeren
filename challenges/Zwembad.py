...
km = 60
tegelmeerpijs = 0
lengte = int(input('Voer de lengte in van je zwembad'))
breedte = int(input('Voer de breedte in van je zwembad'))
diepte = float(input('Voer de diepte/hoogte in van je zwembads'))
